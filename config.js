...
global.github = 'https://github.com/tharindusupun/THARINDU-MD'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/' // add your username
global.sudo = process.env.SUDO || '2347039570336,762175364'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Tharindu 𝐁𝐨𝐭' : process.env.BOT_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '✰𝐓𝐇𝐀𝐑𝐈𝐍𝐃𝐔 𝐌𝐃✰' : process.env.PACK_INFO.split(";")[1],
  ...
  LANG: process.env.THEME|| 'THARINDU',
